	...
	public sealed class SplashRipple : Control, INotifyPropertyChanged 
	{
		...
		async Task CreateResourcesAsync( ICanvasAnimatedControl sender )
		{
			if ( dissolveEffect == null )
			{
				...
				dissolveEffect = new PixelShaderEffect( await AppStorage.AppXGetBytes( "GR/Shaders/Dissolve.bin" ) );
				rippleEffect = new PixelShaderEffect( await AppStorage.AppXGetBytes( "GR/Shaders/Ripples.bin" ) );
			}
